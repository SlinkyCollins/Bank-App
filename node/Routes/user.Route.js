...
const {welcomeUser, registerUser, loginUser, dashboard, updateProfile, sendMail, forgotPassword, resetPassword, sendResetMail, sendResetConfirmationEmail} = require("../Controllers/user.Controller")
